// Generated by Rampage on 2025-02-07 08:13:59.741996
...
extension type AbortSignal._(JSObject _) implements JSObject, EventTarget {
  ...
  external static AbortSignal _any(JSArray<AbortSignal> signals);
...
extension type Document._(JSObject _)
  ...
  external ViewTransition startViewTransition([
    ViewTransitionUpdateCallback updateCallback,
  ]);
  external static Document parseHTMLUnsafe(JSAny html);
  external NodeList getElementsByName(String elementName);
  external JSObject? open([String unusedOrUrl, String unused2OrName, String features]);
  //external Document open([String unused1, String unused2]);
  //external WindowProxy? open(String url, String name, String features);
  external void close();
